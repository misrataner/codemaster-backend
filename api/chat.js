export default async function handler(req, res) {
  ...
  try {
    ...
    const prompt =
      ...
      'Öğrenci kod isterse ASLA lafı uzatma, doğrudan tam çalışan C# kodu ver. ' +
      'Kod cevabı mutlaka Markdown code block içinde ver. Format aynen şöyle olmalı: ```csharp\\nKOD BURAYA\\n``` ' +
      'Kod eksik kalmasın. Hesap makinesi istenirse toplama, çıkarma, çarpma, bölme içeren tam console uygulaması yaz. ' +
      'Öğrenci “tamamını yaz”, “kodunu yaz”, “program yaz”, “uygulama yap”, “yapar mısın” derse tam kod ver. ' +
